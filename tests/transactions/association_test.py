...
class TestAssociation:
    ...
    def test_construct(self):
        transaction = Association(1, '3N3Cn2pYtqzj7N9pviSesNe8KG9Cmb718Y1')
    ...
    def test_construct_with_data(self):
        transaction = Association(1, '3N3Cn2pYtqzj7N9pviSesNe8KG9Cmb718Y1', data=self.data_entries)
    ...
    def test_from_data(self):
        data = {
            ...
            "proofs": ["2jQMruoLoshfKe6FAUbA9vmVVvAt8bVpCFyM75Z2PLJiuRmjmLzFpM2UmgQ6E73qn46AVQprQJPBhQe92S7iSXbZ"],
            "height": 1225712
        }
        ...
        assert transaction.sender_key_type == "ed25519"
        assert transaction.sender_public_key == "4EcSxUkMxqxBEBUBL2oKz3ARVsbyRJTivWpNrYQGdguz"
        assert transaction.fee == 60000000
        assert transaction.timestamp == 1629883934685

        assert transaction.association_type == 1
        assert transaction.subject.base58() == '3mM7VirFP1LfJ5kGeWs9uTnNrM2APMeCcmezBEy8o8wk'
